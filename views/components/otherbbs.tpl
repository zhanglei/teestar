<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <br><br>自动点赞脚本：<a target="_blank" href="https://github.com/w568w/GitHubStar">GitHubStar</a>
    <br><br>其他友情群：
    <br>Github Star群（491542152）
    <br>github互star（428687435）
    <br>Github互粉（106509962）
    <br>GitHub互赞---！（98723592）
    <br><br>支持作者开发：<a href="/about"><b>捐赠本项目</b></a>
